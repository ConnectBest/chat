...
class MessageDetail(Resource):
    ...
    def put(self, message_id):
        ...
        try:
            ...
            db = current_app.db
            message_model = Message(db)
            message = message_model.update(message_id, content, payload['user_id'])
    ...
    def delete(self, message_id):
        ...
        try:
            ...
            db = current_app.db
            message_model = Message(db)
            success = message_model.delete(message_id, payload['user_id'])
...
class MessageBookmark(Resource):
    ...
    def post(self, message_id):
        ...
        try:
            ...
            db = current_app.db
            message_model = Message(db)
            result = message_model.toggle_bookmark(message_id, payload['user_id'])
...
class ThreadReplies(Resource):
    ...
    def post(self, message_id):
        ...
        try:
            ...
            channel_model = Channel(db)
            if not channel_model.is_member(parent_message['channel_id'], payload['user_id']):
                return {'error': 'Not a member of this channel'}, 403
...
class MessageReactions(Resource):
    ...
    def post(self, channel_id, message_id):
        ...
        try:
            ...
            success = message_model.add_reaction(message_id, payload['user_id'], emoji)
    ...
    def delete(self, channel_id, message_id):
        ...
        try:
            ...
            # Remove reaction
            success = message_model.remove_reaction(message_id, payload['user_id'])
